...
function UIMenuItem.New(Text, Description)
    _UIMenuItem = {
        ...
        SelectedSprite = Sprite.New("commonmenu3", "gradient_nav", 0, 0, 431, 38),
        LeftBadge = { Sprite = Sprite.New("commonmenu3", "", 0, 0, 40, 40), Badge = 0},
        RightBadge = { Sprite = Sprite.New("commonmenu3", "", 0, 0, 40, 40), Badge = 0},
        Label = {
...
function UIMenuCheckboxItem.New(Text, Check, Description)
    local _UIMenuCheckboxItem = {
        ...
        CheckedSprite = Sprite.New("commonmenu3", "shop_box_blank", 410, 95, 50, 50),
...
function UIMenuListItem.New(Text, Items, Index, Description)
    ...
    local _UIMenuListItem = {
        Base = UIMenuItem.New(Text or "", Description or ""),
        Items = Items,
        LeftArrow = Sprite.New("commonmenu3", "arrowleft", 110, 105, 30, 30),
        RightArrow = Sprite.New("commonmenu3", "arrowright", 280, 105, 30, 30),
...
function UIMenuSliderItem.New(Text, Items, Index, Description, Divider)
    ...
    local _UIMenuSliderItem = {
        ...
        LeftArrow = Sprite.New("commonmenu3tu", "arrowleft", 0, 105, 15, 15),
        RightArrow = Sprite.New("commonmenu3tu", "arrowright", 0, 105, 15, 15),
...
function UIMenuGridPanel.New(TopText, LeftText, RightText, BottomText)
    _UIMenuGridPanel = {
        ...
        Background = Sprite.New("commonmenu3", "gradient_bgd", 0, 0, 431, 275),
...
function UIMenuColourPanel.New(Title, Colours)
    _UIMenuColourPanel = {
        ...
        Background = Sprite.New("commonmenu3", "gradient_bgd", 0, 0, 431, 112),
        Bar = {},
        LeftArrow = Sprite.New("commonmenu3", "arrowleft", 0, 0, 30, 30),
        RightArrow = Sprite.New("commonmenu3", "arrowright", 0, 0, 30, 30),
...
function UIMenuPercentagePanel.New(MinText, MaxText)
    _UIMenuPercentagePanel = {
        ...
        Background = Sprite.New("commonmenu3", "gradient_bgd", 0, 0, 431, 76),
...
function UIMenu.New(Title, Subtitle, X, Y, TxtDictionary, TxtName)
    ...
    if TxtDictionary ~= nil then TxtDictionary = tostring(TxtDictionary) or "commonmenu3" else TxtDictionary = "commonmenu3" end
    ...
    _UIMenu.ArrowSprite = Sprite.New("commonmenu3", "shop_arrows_upanddown", 190 + _UIMenu.Position.X, 147 + 37 * (_UIMenu.Pagination.Total + 1) + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 50, 50)
    ...
    _UIMenu.Description.Rectangle = Sprite.New("commonmenu3", "gradient_bgd", _UIMenu.Position.X, 127, 431, 30)
    _UIMenu.Description.Text = UIResText.New("Description", _UIMenu.Position.X + 5, 125, 0.35)

    _UIMenu.Background = Sprite.New("commonmenu3", "gradient_bgd", _UIMenu.Position.X, 144 + _UIMenu.Position.Y - 37 + _UIMenu.Subtitle.ExtraY, 290, 25)
